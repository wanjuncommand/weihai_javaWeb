<template>
  <el-dialog :visible.sync="dialog" :close-on-click-modal="false" :before-close="cancel" :title="isAdd ? '新增优惠券下发' : '编辑优惠券下发'" append-to-body width="800px">
    <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="100px">
      <el-row>
        <el-col span="11">
          <el-form-item label="优惠券" prop="adTitle">
      ...
      <el-row>
        <el-col span="11">
          <el-form-item label="发放位置" prop="adTitle">
            <el-select v-model="form.issueAddress" placeholder="请选择">
              <el-option
        ...
        <el-col span="11">
          <el-form-item label="发放日期" prop="adTitle">
            <el-date-picker
      ...
      <el-row>
        <el-col span="11">
          <el-form-item label="结束日期" prop="adTitle">
            <el-date-picker
        ...
        <el-col span="11">
          <el-form-item label="发放数量" prop="adTitle">
            <el-input v-model="form.issueNums"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
import { addCouponIssue, updateCouponIssue } from '@/api/java'
...
export default {
  ...
  methods: {
    ...
    doEdit() {
      updateCouponIssue(this.form).then(res => {
        this.resetForm()
        this.$notify({
          title: '修改成功',
          type: 'success',
